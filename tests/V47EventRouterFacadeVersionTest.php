...
describe('Version — v2.47 consistency', function (): void {
    it('manager version is 2.47.0', function (): void {
        expect($this->manager->version())->toBe('2.47.0');
    });

    it('composer version is 2.47.0', function (): void {
        $composer = json_decode(file_get_contents(__DIR__ . '/../composer.json'), true);

        expect($composer['version'])->toBe('2.47.0');
    });

    it('JS client version is 2.47.0', function (): void {
        $js = file_get_contents(__DIR__ . '/../resources/js/analytics.js');

        expect($js)->toContain("'2.47.0'");
    });

    it('TypeScript definitions version is 2.47.0', function (): void {
        $dts = file_get_contents(__DIR__ . '/../resources/js/analytics.d.ts');

        expect($dts)->toContain('2.47.0');
    });
