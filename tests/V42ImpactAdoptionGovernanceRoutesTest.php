...
final class V42ImpactAdoptionGovernanceRoutesTest extends TestCase
{
    ...
    /**
     * AnalyticsEvent::VERSION must be 266.0.0.
     */
    ...
    /**
     * JS client getVersion() returns 266.0.0.
     */
    public function testJsClientVersion(): void
    {
        $jsContent = file_get_contents(__DIR__ . '/../resources/js/analytics.js');

        // getVersion should return '268.0.0'
        $this->assertStringContainsString("'268.0.0'", $jsContent);
        $this->assertStringContainsString("return '268.0.0';", $jsContent);
    ...
    /**
     * JS client header version is 266.0.0.
     */
    public function testJsClientHeaderVersion(): void
    {
        $jsContent = file_get_contents(__DIR__ . '/../resources/js/analytics.js');

        $this->assertStringContainsString('@version 268.0.0', $jsContent);
    }

    /**
     * TypeScript definitions version is 266.0.0.
     */
    public function testTypeScriptDefinitionsVersion(): void
    {
        $tsContent = file_get_contents(__DIR__ . '/../resources/js/analytics.d.ts');

        $this->assertStringContainsString('@version 268.0.0', $tsContent);
    }

    // ─── Composer Version ──────────────────────────────────────────────

    /**
     * composer.json version is 266.0.0.
     */
    public function testComposerJsonVersion(): void
    {
        $composer = json_decode(file_get_contents(__DIR__ . '/../composer.json'), true);

        $this->assertSame('268.0.0', $composer['version']);
    }
