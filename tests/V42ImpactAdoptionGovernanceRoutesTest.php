...
final class V42ImpactAdoptionGovernanceRoutesTest extends TestCase
{
    ...
    /**
     * AnalyticsEvent::VERSION must be 4.2.0.
     */
    public function testVersionConstant(): void
    {
        $this->assertSame('4.2.0', AnalyticsEvent::VERSION);
    }
    ...
    /**
     * JS client getVersion() returns 4.2.0.
     */
    public function testJsClientVersion(): void
    {
        $jsContent = file_get_contents(__DIR__ . '/../resources/js/analytics.js');

        // getVersion should return '4.2.0'
        $this->assertStringContainsString("'4.2.0'", $jsContent);
        $this->assertStringContainsString('return \'4.2.0\';', $jsContent);
    ...
    /**
     * JS client header version is 4.2.0.
     */
    public function testJsClientHeaderVersion(): void
    {
        $jsContent = file_get_contents(__DIR__ . '/../resources/js/analytics.js');

        $this->assertStringContainsString('@version 4.2.0', $jsContent);
    }

    /**
     * TypeScript definitions version is 4.2.0.
     */
    public function testTypeScriptDefinitionsVersion(): void
    {
        $tsContent = file_get_contents(__DIR__ . '/../resources/js/analytics.d.ts');

        $this->assertStringContainsString('@version 4.2.0', $tsContent);
    }

    // ─── Composer Version ──────────────────────────────────────────────

    /**
     * composer.json version is 4.2.0.
     */
