...
test('v75.0.0 feature 1: ExperimentAnalysisEngine class exists and is final', function (): void {
    expect(ExperimentAnalysisEngine::class)->toBeFinal();
});

test('v75.0.0 feature 2: constructor accepts CacheRepository and ConfigRepository', function (): void {
    $cache = app(CacheRepository::class);
    $config = app(ConfigRepository::class);
...
test('v75.0.0 feature 3: isEnabled returns true when config enabled', function (): void {
    expect($this->engine->isEnabled())->toBeTrue();
});

test('v75.0.0 feature 4: config has experiment_analysis section with required keys', function (): void {
    $config = app(ConfigRepository::class);
...
test('v75.0.0 feature 5: analyze returns full result structure', function (): void {
    $variants = [
...
test('v75.0.0 feature 6: analyze with empty variants returns empty analysis', function (): void {
...
test('v75.0.0 feature 7: analyze caches result', function (): void {
    $variants = [
...
test('v75.0.0 feature 8: clearAnalysis removes cached result', function (): void {
    $variants = [
...
test('v75.0.0 feature 9: frequentist analysis detects significant difference', function (): void {
    $variants = [
...
test('v75.0.0 feature 10: frequentist returns null result when no variant beats control', function (): void {
    $variants = [
...
test('v75.0.0 feature 11: frequentist handles missing control gracefully', function (): void {
    $variants = [
        'variant_a' => ['exposures' => 1000, 'conversions' => 50],
    ];
...
test('v75.0.0 feature 12: bayesian analysis returns P(Best), P(Beat Control), expected loss, credible intervals', function (): void {
    $variants = [
        'control' => ['exposures' => 1000, 'conversions' => 50],
...
test('v75.0.0 feature 13: bayesian credible intervals have valid range [0,1]', function (): void {
    $variants = [
        'control' => ['exposures' => 500, 'conversions' => 25],
...
test('v75.0.0 feature 14: effect size computes relative uplift and Cohen h', function (): void {
    $variants = [
...
test('v75.0.0 feature 15: Wilson score intervals are valid', function (): void {
...
test('v75.0.0 feature 16: computeConfidenceIntervals returns results for all variants', function (): void {
    $variants = [
        'control' => ['exposures' => 1000, 'conversions' => 50],
        'variant_a' => ['exposures' => 1000, 'conversions' => 70],
    ];
...
test('v75.0.0 feature 17: multi-variant correction returns null for 2 variants', function (): void {
    $result = $this->engine->multiVariantCorrection(['a', 'b']);

    expect($result)->toBeNull();
});

test('v75.0.0 feature 18: Bonferroni correction adjusts alpha correctly', function (): void {
...
test('v75.0.0 feature 19: Šidák correction is less conservative than Bonferroni', function (): void {
...
test('v75.0.0 feature 20: sequential test allows continuation with low z-score', function (): void {
...
test('v75.0.0 feature 21: sequential test returns valid structure', function (): void {
...
test('v75.0.0 feature 22: calculateSampleSize returns valid results', function (): void {
...
test('v75.0.0 feature 23: calculateSampleSize with Bonferroni correction for 4 variants', function (): void {
...
test('v75.0.0 feature 24: calculateMDE returns valid results', function (): void {
...
test('v75.0.0 feature 25: quickSignificance returns valid result', function (): void {
...
test('v75.0.0 feature 26: quickSignificance with zero conversions returns non-significant', function (): void {
...
test('v75.0.0 feature 27: assessExperimentHealth returns valid structure', function (): void {
    $variants = [
        'control' => ['exposures' => 500, 'conversions' => 25],
...
test('v75.0.0 feature 28: assessExperimentHealth detects low sample size', function (): void {
    $variants = [
...
test('v75.0.0 feature 29: assessExperimentHealth detects balanced traffic', function (): void {
    $variants = [
        'control' => ['exposures' => 1000, 'conversions' => 50],
...
test('v75.0.0 feature 30: full analysis pipeline — significant result', function (): void {
...
test('v75.0.0 feature 31: AnalyticsExperimentCommand class exists and extends Command', function (): void {
...
test('v75.0.0 feature 32: AnalyticsExperimentCommand has correct signature', function (): void {
