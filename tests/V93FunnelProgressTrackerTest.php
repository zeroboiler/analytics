...
test('config catalog_version is current version', function (): void {
    $config = file_get_contents(__DIR__ . '/../config/zeroboiler.php');
    expect($config)->toContain("'catalog_version' => '5.0.0'");
});
