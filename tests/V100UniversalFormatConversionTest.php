 ...
 *
 * Validates the new v5.9.0 universal cross-provider conversion methods
...
test('v5.9.0: version is 5.9.0 everywhere', function (): void {
    ...
    expect($dts)->toContain('@version 5.9.0');

    $readme = file_get_contents(__DIR__ . '/../README.md');
    expect($readme)->toContain('version-5.9.0');
});

test('v5.9.0: EcommerceFormatConverter has toGa4Format and fromGa4Format methods', function (): void {
...
test('v5.9.0: toGa4Format converts GA4 purchase to Meta format', function (): void {
    $ga4Params = [
...
test('v5.9.0: toGa4Format converts GA4 purchase to Plausible format', function (): void {
    $ga4Params = [
...
test('v5.9.0: toGa4Format passes through GA4 for ga4 target', function (): void {
...
test('v5.9.0: toGa4Format returns null for unsupported Meta events', function (): void {
    $result = EcommerceFormatConverter::toGa4Format('meta', 'unknown_event', ['foo' => 'bar']);

    expect($result['provider_event'])->toBeNull();
});

test('v5.9.0: toGa4Format returns null for unsupported Plausible events', function (): void {
    $result = EcommerceFormatConverter::toGa4Format('plausible', 'unknown_event', ['foo' => 'bar']);

    expect($result['plausible_event'])->toBeNull();
});

test('v5.9.0: fromGa4Format converts Meta Purchase back to GA4', function (): void {
    $metaParams = [
        'content_ids' => ['SKU-001'],
...
test('v5.9.0: fromGa4Format converts Meta AddToCart back to GA4', function (): void {
    $metaParams = [
...
test('v5.9.0: fromGa4Format passes through unknown Meta events', function (): void {
...
test('v5.9.0: fromGa4Format passes through GA4 source unchanged', function (): void {
...
test('v5.9.0: ga4ToPlausibleAuto converts purchase', function (): void {
    $ga4Params = [
...
test('v5.9.0: ga4ToPlausibleAuto converts add_to_cart', function (): void {
    $ga4Params = [
...
test('v5.9.0: ga4ToPlausibleAuto converts refund', function (): void {
    $ga4Params = [
...
test('v5.9.0: ga4ToPlausibleAuto converts begin_checkout', function (): void {
    $ga4Params = [
...
test('v5.9.0: ga4ToPlausibleAuto returns null for unsupported events', function (): void {
...
test('v5.9.0: EcommerceFormatConverter imports EventCatalog', function (): void {
...
test('v5.9.0: README documents v5.9.0 changelog', function (): void {
    $readme = file_get_contents(__DIR__ . '/../README.md');

    expect($readme)->toContain("What's New in v5.9.0");
...
test('v5.9.0: ServiceProvider version docblock is 5.9.0', function (): void {
    $sp = file_get_contents(__DIR__ . '/../src/AnalyticsServiceProvider.php');
    expect($sp)->toContain('@version 5.9.0');
});

test('v5.9.0: event catalog validates cleanly', function (): void {
...
test('v5.9.0: 166+ test files with comprehensive coverage', function (): void {
    $testDir = __DIR__;
