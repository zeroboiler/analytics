 ...
 *
 * Validates v5.7.0 features:
 * - Full version sweep to 5.7.0 across PHP, JS, Svelte, TypeScript, composer
 ...
 */
test('v5.7.0 version sweep: all version references are 5.7.0', function (): void {
...
test('v5.7.0 feature: AnalyticsEventRouter exists with required methods', function (): void {
...
test('v5.7.0 feature: AnalyticsEventRouter pattern matching works correctly', function (): void {
...
test('v5.7.0 feature: AnalyticsEventRouter runtime rule management', function (): void {
    $manager = new AnalyticsManager;
    $config = new Illuminate\Config\Repository([
        'zeroboiler' => [
            'analytics' => [
...
test('v5.7.0 feature: ProviderHealthMonitor exists with required methods', function (): void {
...
test('v5.7.0 feature: ProviderHealthMonitor tracks health scores', function (): void {
...
test('v5.7.0 feature: ProviderHealthMonitor summary returns all providers', function (): void {
    $metrics = new ZeroBoiler\Analytics\AnalyticsMetrics;
    $config = new Illuminate\Config\Repository([
        'zeroboiler' => [
            'analytics' => [
    ...
    expect($summary['version'])->toBe('5.7.0');
...
test('v5.7.0 feature: config has routing and provider_health sections', function (): void {
...
test('v5.7.0 feature: routes include routing and provider-health endpoints', function (): void {
...
test('v5.7.0 feature: JS client has trackEventWithProviders and trackEcommerceWithProviders', function (): void {
    $js = file_get_contents(__DIR__ . '/../resources/js/analytics.js');
...
test('v5.7.0 feature: config section count is 27+', function (): void {
    $config = file_get_contents(__DIR__ . '/../config/zeroboiler.php');
    expect($config)->not->toBeFalse();
...
test('v5.7.0 feature: route count is 155+', function (): void {
    $routes = file_get_contents(__DIR__ . '/../routes/analytics.php');
    expect($routes)->not->toBeFalse();
...
test('v5.7.0 backward compatibility: event catalog still intact', function (): void {
