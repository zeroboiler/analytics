...
test('v5.7.0 version is set correctly', function (): void {
...
test('JS client version is 5.7.0', function (): void {
    $content = file_get_contents(__DIR__.'/../resources/js/analytics.js');

    expect($content)->toContain("'5.7.0'");
});

test('composer.json version is 5.7.0', function (): void {
