...
test('v5.9.0 version is set correctly', function (): void {
...
test('Svelte composables file exists and is valid JS', function (): void {
    ...
    expect($content)->toContain('@version 5.9.0');
});
...
test('JS client version is 5.9.0', function (): void {
    $content = file_get_contents(__DIR__.'/../resources/js/analytics.js');

    expect($content)->toContain("'5.9.0'");
});

test('composer.json version is 5.9.0', function (): void {
