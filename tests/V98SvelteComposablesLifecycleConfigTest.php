...
test('v4.6.0 version is set correctly', function (): void {
...
test('JS client version is 4.6.0', function (): void {
    $content = file_get_contents(__DIR__.'/../resources/js/analytics.js');

    expect($content)->toContain("'4.6.0'");
});

test('composer.json version is 4.6.0', function (): void {
