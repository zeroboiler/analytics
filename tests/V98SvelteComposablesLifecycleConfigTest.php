...
test('v75.0.0 version is set correctly', function (): void {
...
test('Svelte composables file exists and is valid JS', function (): void {
    ...
    expect($content)->toContain('@version 75.0.0');
});
...
test('JS client version is 75.0.0', function (): void {
    $content = file_get_contents(__DIR__.'/../resources/js/analytics.js');

    expect($content)->toContain("'75.0.0'");
});

test('composer.json version is 75.0.0', function (): void {
