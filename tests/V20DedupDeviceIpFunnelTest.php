...
describe('DeviceContextService', function (): void {
    it('detects Chrome browser', function (): void {
        ...
        expect($service->detectBrowser('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/125.7.0.0'))
            ->toBe('Chrome');
    });
    ...
    it('detects desktop device', function (): void {
        ...
        expect($service->isDesktop('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/125.7.0.0'))
            ->toBeTrue();
    });
    ...
    it('detects device type as desktop', function (): void {
        ...
        $ua = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/125.7.0.0';
    ...
    it('returns full parsed context', function (): void {
        ...
        $result = $service->parseUserAgent('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/125.7.0.0');
