...
describe('v2.74.0 — Industry Standard SaaS Starter Upgrade', function () {
    ...
    describe('AnalyticsManager version', function () {
        it('version returns 2.74.0', function () {
            ...
            expect($manager->version())->toBe('2.74.0');
        });
    });
