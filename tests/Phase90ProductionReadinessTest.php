 ...
 *
 * Validates:
 * 1. Version consistency (263.0.0) across all entry points
...
{
    private const EXPECTED_VERSION = '263.0.0';
    ...
    public function testVersionConsistencyAcrossEntryPoints(): void
    {
        foreach (self::VERSION_ENTRY_POINTS as $relativePath) {
            ...
            $this->assertStringContainsString(
                ...
                $content,
                "Version entry point contains 263.0.0: {$relativePath}",
            );
        }
    }
    ...
    public function testAnalyticsEventVersionConstant(): void
    {
        ...
        $this->assertStringContainsString(
            "public const VERSION = '263.0.0'",
            $content,
            'AnalyticsEvent::VERSION is 263.0.0',
        );
    }
    ...
    public function testIntegrityCommandExpectedVersion(): void
    {
        ...
        $this->assertStringContainsString(
            "EXPECTED_VERSION = '263.0.0'",
            $content,
            'AnalyticsIntegrityCommand::EXPECTED_VERSION is 263.0.0',
        );
    }
