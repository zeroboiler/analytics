...
test('version consistency across all sources is 2.90.0', function (): void {
    ...
    // AnalyticsEvent DTO
    expect(\ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION)->toBe('2.91.0');
    ...
    expect(str_contains($dts, '2.91.0'))->toBeTrue();
