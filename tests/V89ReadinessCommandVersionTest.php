...
test('version consistency across all sources is 2.90.0', function (): void {
    ...
    // AnalyticsEvent DTO
    expect(\ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION)->toBe('2.95.0');
