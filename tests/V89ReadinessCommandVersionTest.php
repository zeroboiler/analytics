...
test('version consistency across all sources is 2.90.0', function (): void {
    ...
    // AnalyticsEvent DTO
    expect(\ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION)->toBe('2.93.0');
    ...
    expect(str_contains($js, "'2.93.0'"))->toBeTrue();

    // TypeScript
    $dts = file_get_contents(dirname(__DIR__, 2).'/resources/js/analytics.d.ts');
    expect(str_contains($dts, '2.93.0'))->toBeTrue();
