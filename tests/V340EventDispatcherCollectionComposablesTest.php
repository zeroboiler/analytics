...
describe('v3.4.0 Version Consistency', function () {
    ...
    it('version is 5.9.0 across PHP and JS', function () {
        $phpVersion = \ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION;

        expect($phpVersion)->toBe('5.9.0');
    });
    ...
    it('composer.json version is 5.9.0', function () {
    ...
    it('Svelte composable version is 5.9.0', function () {
