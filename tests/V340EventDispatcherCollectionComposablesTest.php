...
describe('v3.4.0 Version Consistency', function () {
    ...
    it('version is 75.0.0 across PHP and JS', function () {
        $phpVersion = \ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION;

        expect($phpVersion)->toBe('75.0.0');
    });
    ...
    it('composer.json version is 75.0.0', function () {
    ...
    it('Svelte composable version is 75.0.0', function () {
