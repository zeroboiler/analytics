...
describe('v3.4.0 Version Consistency', function () {
    ...
    it('version is 3.5.0 across PHP and JS', function () {
        $phpVersion = \ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION;

        expect($phpVersion)->toBe('3.5.0');
    });
    ...
    it('composer.json version is 3.5.0', function () {
        $composer = json_decode(
            file_get_contents(__DIR__ . '/../composer.json'),
            true,
        );

        expect($composer['version'])->toBe('3.5.0');
    });
    ...
    it('JS client library version is 3.5.0', function () {
        ...
        expect($js)->toContain("'3.5.0'");
    });

    it('Svelte composable version is 3.5.0', function () {
        $svelte = file_get_contents(__DIR__ . '/../resources/js/useAnalytics.svelte.js');

        expect($svelte)->toContain('@version 3.5.0');
    });
