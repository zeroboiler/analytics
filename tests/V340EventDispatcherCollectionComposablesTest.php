...
describe('v3.4.0 Version Consistency', function () {
    ...
    it('version is 266.0.0 across PHP and JS', function () {
        $phpVersion = \ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION;

        expect($phpVersion)->toBe('268.0.0');
    });
    ...
    it('JS client library version is 266.0.0', function () {
        $js = file_get_contents(__DIR__ . '/../resources/js/analytics.js');

        expect($js)->toContain("'268.0.0'");
    });

    it('Svelte composable version is 266.0.0', function () {
