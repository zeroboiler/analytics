...
describe('v3.4.0 Version Consistency', function () {
    ...
    it('version is 3.4.0 across PHP and JS', function () {
        $phpVersion = \ZeroBoiler\Analytics\DTO\AnalyticsEvent::VERSION;

        expect($phpVersion)->toBe('3.4.0');
    });
    ...
    it('composer.json version is 3.4.0', function () {
    ...
    it('JS client library version is 3.4.0', function () {
        $js = file_get_contents(__DIR__ . '/../resources/js/analytics.js');

        expect($js)->toContain("'3.4.0'");
    });

    it('Svelte composable version is 3.4.0', function () {
        $svelte = file_get_contents(__DIR__ . '/../resources/js/useAnalytics.svelte.js');

        expect($svelte)->toContain('@version 3.4.0');
    });
