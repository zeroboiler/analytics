...
describe('Version consistency', function (): void {
    test('version is 2.64.0 across key files', function (): void {
        ...
        expect($composerJson)->toContain('2.64.0');
        expect($managerPhp)->toContain('2.64.0');
        expect($analyticsJs)->toContain('2.64.0');
    });
