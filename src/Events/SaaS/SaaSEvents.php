...
final class SaaSEvents
{
    ...
    private static function catalog(): array
    {
        ...
        self::$catalog = [
            ...
            // Revenue intelligence events (v174.0.0)
            'contraction_revenue' => [
                'name' => 'contraction_revenue',
                'class' => ContractionRevenueEvent::class,
                'ga4' => 'contraction_revenue',
                'meta' => null,
                'posthog' => 'contraction_revenue',
                'plausible' => null,
                'mixpanel' => 'Contraction Revenue',
                'amplitude' => 'Contraction Revenue',
                'tiktok' => null,
                'linkedin' => null,
            ],
            'net_revenue_retention' => [
                'name' => 'net_revenue_retention',
                'class' => NetRevenueRetentionEvent::class,
                'ga4' => 'net_revenue_retention',
                'meta' => null,
                'posthog' => 'net_revenue_retention',
                'plausible' => null,
                'mixpanel' => 'Net Revenue Retention',
                'amplitude' => 'Net Revenue Retention',
                'tiktok' => null,
                'linkedin' => null,
            ],
            'burn_multiple' => [
                'name' => 'burn_multiple',
                'class' => BurnMultipleEvent::class,
                'ga4' => 'burn_multiple',
                'meta' => null,
                'posthog' => 'burn_multiple',
                'plausible' => null,
                'mixpanel' => 'Burn Multiple',
                'amplitude' => 'Burn Multiple',
                'tiktok' => null,
                'linkedin' => null,
            ],
            'arr_milestone' => [
                'name' => 'arr_milestone',
                'class' => ArrMilestoneEvent::class,
                'ga4' => 'arr_milestone',
                'meta' => null,
                'posthog' => 'arr_milestone',
                'plausible' => null,
                'mixpanel' => 'ARR Milestone',
                'amplitude' => 'ARR Milestone',
                'tiktok' => null,
                'linkedin' => null,
            ],
            'payback_period' => [
                'name' => 'payback_period',
                'class' => PaybackPeriodEvent::class,
                'ga4' => 'payback_period',
                'meta' => null,
                'posthog' => 'payback_period',
                'plausible' => null,
                'mixpanel' => 'Payback Period',
                'amplitude' => 'Payback Period',
                'tiktok' => null,
                'linkedin' => null,
            ],
        ];
