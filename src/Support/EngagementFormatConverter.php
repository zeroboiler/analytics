 ...
 * search, share, error) between GA4, Meta Pixel, PostHog, and generic formats.
 *
...
final class EngagementFormatConverter
{
    ...
    // ── Generic Engagement Event Converter ───────────────────────────
     ...
     * based on event name and target provider. Supports the 8 core
     * engagement events plus aliases (start_trial/subscription, etc.).
     *
