...
- Total: 73.5K+ LOC PHP source, 5.2K+ LOC JS client, 850+ LOC Svelte composables, 200 test files, 130+ API routes, 100+ event classes, 6 provider trackers
